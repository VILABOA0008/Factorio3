...
public class Leer {
  ...
  public void toJavaSyntax() throws SQLException {
    ...
    toVars.put("VARBINARY", "byte[]");
    toVars.put("BLOB", "byte[]");
...
//                }}
  ...
  public Connection connect() throws SQLException {
    ...
    Connection con = null;
//     String url = "jdbc:mysql://localhost:3306/psa-pei-energy-management";
//    String url = "jdbc:mysql://invisibilizame-esta-crack.cyygmzlpbn3a.eu-west-2.rds.amazonaws.com:3306/invisibilizame-esta-crack?user=admin&password=administrameestacrack";
